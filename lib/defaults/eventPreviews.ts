  ...
  },
  {
    ...
    notes: [
      ...
      },
      {
        ...
        text: {
          pt: "Acumule bonus points no evento para comprar as peças exclusivas com o representante do seu mago.",
          en: "Earn event points to buy exclusive chess pieces from your wizard's representative.",
          es: "Acumula bonus points en el evento para comprar las piezas exclusivas con el representante de tu mago.",
          pl: "Zbieraj bonus points w wydarzeniu, by kupić ekskluzywne figury u przedstawiciela swojego maga.",
        },
      },
      {
        emoji: "🏆",
        ...
        text: {
          pt: "Participe do The Colours of Magic três vezes, com qualquer cor, 3 achievement points.",
          en: "Take part in The Colours of Magic three times, in any colour, 3 achievement points.",
          es: "Participa en The Colours of Magic tres veces, con cualquier color, 3 achievement points.",
          pl: "Weź udział w The Colours of Magic trzy razy, w dowolnym kolorze, 3 pkt achievement.",
        },
      },
    ],
    sources: [
